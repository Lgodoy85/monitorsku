		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monitor SKU",
									"targetURL": "#geoskumonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"geoskumonitor-display": {
								"semanticObject": "geoskumonitor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=geo.skumonitor",
									"url": sap.ui.require.toUrl("geo/skumonitor")
								}
							}
						}
					}
